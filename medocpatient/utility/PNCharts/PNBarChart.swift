    ...
    func strokeChart() {
        ...
        for value in self.yValues {
            ...
            if self.barWidth != nil && self.barWidth > 0 {
                barXPosition = (CGFloat(index) * CGFloat(self.xLabelWidth)) + (CGFloat(self.yChartLabelWidth) + CGFloat(self.chartMargin) + CGFloat(self.xLabelWidth / 2) - CGFloat(self.barWidth / 2))
            } else {
