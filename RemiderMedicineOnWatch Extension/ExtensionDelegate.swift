...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func handleAction(withIdentifier identifier: String?, forRemoteNotification remoteNotification: [AnyHashable : Any], withResponseInfo responseInfo: [AnyHashable : Any]) {
        print("2" + "\(identifier)")
    }
}
