...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @IBInspectable dynamic open var selectedTitleColor: UIColor = UIColor(red: 0, green: 187/255, blue: 204/255, alpha: 1.0) {
        didSet {
            updateTitleColor()
        }
    }
    ...
    @IBInspectable dynamic open var selectedLineColor: UIColor = UIColor(red: 0, green: 187/255, blue: 204/255, alpha: 1.0) {
        didSet {
            updateLineView()
        }
    }
